...
import { HaybondOwnershipDetail } from '@/components/haybond/ownership-detail/HaybondOwnershipDetail';
...
export default function HayBondOwnedHistoryDetail() {
