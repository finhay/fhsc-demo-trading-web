...
export const HaybondFlexibleListCommand = () => {
    const trans = useTranslate();
    const { dataPreview } = useHaybondFlexStore();
    const { symbol, agreementData } = dataPreview;
        ...
        <div className="flex flex-col gap-6">
            <div className="bg-tertiary rounded-xl p-3 font-caption text-secondary">
                ...
                <ul className="mt-1 list-disc pl-4">
                    <li>{trans.haybond.dynamic.order_info.detail_1}</li>
                    <li>{trans.haybond.dynamic.order_info.detail_2}</li>
                    <li>{trans.haybond.dynamic.order_info.detail_3}</li>
                </ul>
            </div>
